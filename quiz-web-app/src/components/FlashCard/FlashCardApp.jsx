...
function FlashcardApp() {
  ...
  return (
    <div className="flex flex-col items-center justify-center mr-6 ml-6 w-full mt-0">
      <Flashcard front={questions[currentIndex].front} back={questions[currentIndex].back} />
